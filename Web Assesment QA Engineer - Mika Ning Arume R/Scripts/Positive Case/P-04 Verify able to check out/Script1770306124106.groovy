...
WebUI.setText(findTestObject('Page_Swag Labs/input_Checkout Your Information_first-name'), 'dewi')

WebUI.setText(findTestObject('Page_Swag Labs/input_Checkout Your Information_last-name'), 'cinta')

WebUI.setText(findTestObject('Page_Swag Labs/input_Checkout Your Information_postal-code'), '171717')
